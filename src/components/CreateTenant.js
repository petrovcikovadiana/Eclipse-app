...
function CreateTenant({ post, onDeletePost, onEditPost }) {
        ...
        {showDeleteConfirmation && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
            <motion.div
              ...
              className="flex flex-col items-center ring-1 ring-buttonViolet/30 p-10 rounded-lg bg-zinc-300 backdrop-filter backdrop-blur-md bg-opacity-10"
            >
              <h1 className="text-white font-bold text-lg mb-3">Delete post</h1>
              ...
              <div className="flex justify-center mt-8">
                ...
                >
                  ...
                  <div class="relative z-10 text-sm flex items-center px-3 py-2 space-x-2 rounded-lg  bg-gradient-to-r from-[#7c2889] via-[#59277c]">
                    <p> {t('yes')}</p>
                  </div>
